...
<head>
    ...
    <title>Admin Login | Medilink Emergency Clinic</title>
    ...
    <main class="container py-5">
        <div class="auth-card mx-auto">
            <div class="text-center mb-4">
                ...
                <p class="text-muted mb-0">Use administrator credentials to access Medilink management tools.</p>
            </div>
            ...
            <form method="post" novalidate>
                <div class="mb-3">
                    ...
                    <input
                        ...
                        name="email"
                        value="<?= e($email); ?>"
                        placeholder="admin@medilinkclinic.com"
                        required
                    >
                </div>
                <div class="mb-4">
            ...
            <div class="mt-4 small text-muted text-center">
                ...
                <?php else: ?>
                    Doctor or patient access? <a href="login.php">Open the main login</a>.
                <?php endif; ?>
            </div>
        </div>
    </main>
